...
2. Для позиций в строке **R**, которые лежат на границах текущего слоя спирали, вычисляем значения по формуле квадрата стороны слоя (тут постарайтесь понять как работают формулы пжпжпж, а то даже не интересно выходит с готовым кодом).
3. Дополняем оставшиеся позиции в строке, двигаясь от известных граничных значений влево/вправо.
